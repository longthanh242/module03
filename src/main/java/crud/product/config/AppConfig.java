...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"crud.product.controller", "crud.product.repository.imp", "crud.product.service.imp", "crud.product.config"})
...
public class AppConfig {
    ...
    // 4. Cấu hình EntityManagementFactory
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        LocalContainerEntityManagerFactoryBean entityManagerFactory = new LocalContainerEntityManagerFactoryBean();
        entityManagerFactory.setDataSource(dataSource());
        entityManagerFactory.setPackagesToScan("crud.product.model");
    ...
    public CommonsMultipartResolver multipartResolver() {
        ...
        // dung lượng tối đa của 1 ảnh: 5mb
